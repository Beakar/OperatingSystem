...
/**
     ...
     * 
     * @param virtAddr virtual address that is to be translated
    ...
    {    	
        ...
        //get the page table entry for this page number
        int framenum = m_RAM.read(pageNum);
        
        int entry = framenum << m_offsetSize;        
        int offset = virtAddr & m_offsetMask;
        
        //physical address is the entry value and an offset
        return (entry + offset);
    }//translate
